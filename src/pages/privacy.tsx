  ...
  return (
    <div className="flex center col jc gap-10 inter p-20 m-20">
      ...
      >
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Webstory Code Generator - Coolhead.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Webstory Code Generator -
              Coolhead, accessible from{" "}
              <a
                href="https://webstory.coolhead.in"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://webstory.coolhead.in
              </a>
            </p>
          </li>
          <li>
        ...
        <h1>Google ads Cookies</h1>
        <p>
          Third party vendors, including Google, use cookies to serve ads based
          on a user&rsquo;s previous visits to your website or other websites.
          ...
          users to opt out of a third-party vendor&rsquo;s use of cookies for
          personalised advertising by visiting www.aboutads.info.)
        </p>
        <h1>Links to Other Websites</h1>
        <p>
          Our Service may contain links to other websites that are not operated
          by Us. If You click on a third party link, You will be directed to
          that third party&lsquo;s site. We strongly advise You to review the
